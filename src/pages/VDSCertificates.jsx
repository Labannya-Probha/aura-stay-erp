...
export default function VDSCertificates() {
  ...
  const [f, setF] = useState({ 
    ...
    vat_deducted: '', cert_no: '', challan_no: '', challan_date: '' 
  })
  ...
  const add = async () => {
    ...
    const { error } = await supabase.from('vds_certificates').insert({
    ...
    if (error) {
      ...
      setF({ vendor_name: '', bin_number: '', invoice_amount: '', vat_deducted: '', cert_no: '', challan_no: '', challan_date: '' })
      load()
    }
  }
