...
BEGIN
  ...
  IF EXISTS (
    ...
    VALUES
      (v_report_id, 'property_name', 'Property', 'Property', 'Text', 'property_name', NULL, NULL, 'left', true, true, false, 1, true),
      (v_report_id, 'occupancy_rate', 'Occupancy %', 'Occupancy %', 'Percent', 'occupancy_rate', 'Percent-2', 'SUM', 'right', true, false, false, 2, true),
      (v_report_id, 'adr', 'ADR', 'ADR', 'Currency-BDT', 'adr', 'Currency-BDT', 'SUM', 'right', true, false, false, 3, true),
      (v_report_id, 'revpar', 'RevPAR', 'RevPAR', 'Currency-BDT', 'revpar', 'Currency-BDT', 'SUM', 'right', true, false, false, 4, true),
      (v_report_id, 'room_revenue', 'Room Revenue', 'Room Revenue', 'Currency-BDT', 'room_revenue', 'Currency-BDT', 'SUM', 'right', true, false, false, 5, true),
      (v_report_id, 'gop', 'GOP', 'GOP', 'Currency-BDT', 'gop', 'Currency-BDT', 'SUM', 'right', true, false, false, 6, true),
      (v_report_id, 'net_profit', 'Net Profit', 'Net Profit', 'Currency-BDT', 'net_profit', 'Currency-BDT', 'SUM', 'right', true, false, false, 7, true);
  ELSE
    INSERT INTO public.report_fields (
      report_id,
      field_key,
