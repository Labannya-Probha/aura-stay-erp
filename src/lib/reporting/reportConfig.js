...
const REPORT_TEMPLATE_DEFINITIONS = [
  ...
  },
  {
    ...
    department: 'Accounts',
    departmentSlug: 'accounts',
    name: 'AR/AP Aging Schedule',
    title: 'AR/AP Aging Schedule',
    slug: 'ar-ap-aging-schedule',
    route: '/reports/accounts/ar-ap-aging-schedule',
    exportPermission: true,
    printPermission: true,
  },
  {
    ...
    department: 'Accounts',
    departmentSlug: 'accounts',
    name: 'USALI Departmental Statement',
    title: 'USALI Departmental Statement',
    slug: 'usali-departmental-statement',
    route: '/reports/accounts/usali-departmental-statement',
    exportPermission: true,
    printPermission: true,
  },
  {
    ...
    name: 'Reporting FX Snapshot',
    title: 'Reporting FX Snapshot',
    slug: 'reporting-fx-snapshot',
    route: '/reports/admin/reporting-fx-snapshot',
    exportPermission: true,
    printPermission: true,
  },
  {
...
export function getReportByCode(code) {
  return (
    REPORT_TEMPLATES.find((report) => report.code === code || report.reportCode === code) || null
  )
}
