...
| File                                                                             | Type          | Purpose                                                    |
| -------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------- |
| [src/pages/ReservationDetail.jsx](src/pages/ReservationDetail.jsx)               | Feature       | Discount modal, tax integration, quotation/folio updates   |
| [migrations/001_add_discount_policy.sql](migrations/001_add_discount_policy.sql) | Migration     | Database schema: `discount_pct`, `discount_reason` columns |
| [DISCOUNT_AND_TAX_POLICY.md](DISCOUNT_AND_TAX_POLICY.md)                         | Documentation | Complete user guide & API reference                        |
...
- Visit [https://novem-erp.vercel.app](https://novem-erp.vercel.app)
