...
export default function ChannelManagerTab() {
  ...
  async function saveConnection() {
    ...
    if (error) {
      ...
      setMessage(
        "Connection created. Configure provider credentials securely before enabling live synchronization."
      )
      setForm(EMPTY_FORM)
      setFormOpen(false)
      await load()
        ...
        <div className="aeds-card p-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-slate-500">
                Provider Name is a manual text field.
              </p>
            </div>
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            <Field label="Provider Name">
              <input
                ...
                placeholder="Booking.com, Agoda, Local Travel Agent..."
              />
            </Field>
